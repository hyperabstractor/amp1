...
const [removing, remove] = createServerAction$(
      ...
      return (
        <>
        <Form class="css_ljsnpo6v" data-name="testform4">
<one-select data-custom="true" data-type="ONE-SELECT" name="select" label="Select" class="css_ljsnpo6w" options="[&quot;Option 1&quot;,&quot;Option 2&quot;,&quot;Option 3&quot;]"></one-select>
<one-radio data-custom="true" name="radio1" label="Radio 1" class="css_ljsnpo6x" columns="3" options="[&quot;Option 1&quot;,&quot;Option 2&quot;,&quot;Option 3&quot;]"></one-radio>
<one-checkbox data-type="ONE-CHECKBOX" data-custom="true" type="checkbox" name="check1" label="Check 1" class="css_ljsnpo6y" columns="3" options="[&quot;Option 1&quot;,&quot;Option 2&quot;,&quot;Option 3&quot;]"></one-checkbox>
<button type="submit" class="css_ljsnpo6z">
Submit
</button>
</Form>
